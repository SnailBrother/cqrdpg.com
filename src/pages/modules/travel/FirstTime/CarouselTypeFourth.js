  ...
  const items = [
    {
      ...
      src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFourth/1.jpg`,
      position: 'top-left'
    },
    {
      title: '渝北园博园',
      desc: '山顶',
      staticDesc: '陈宝宝在(*^_^*)',
      src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFourth/2.jpg`,
      position: 'top-right'
    },
    {
      title: '家天下',
      desc: '躺在床上还不起来',
      staticDesc: '陈宝宝在睡懒觉',
      src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFourth/3.jpg`,
