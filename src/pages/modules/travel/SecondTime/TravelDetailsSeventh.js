    ...
    <div className="traveldetailsseventh-container">
      <div className="traveldetailsseventh-slide">
        ...
        <div 
          ...
          style={{ backgroundImage: `url(http://121.4.22.55:8888/backend/images/OurHomePage/Details/TravelDetailsSeventh/1.jpg)` }}
        >
        ...
        <div 
          className="traveldetailsseventh-item" 
          style={{ backgroundImage: `url(http://121.4.22.55:8888/backend/images/OurHomePage/Details/TravelDetailsSeventh/2.jpg)` }}
        >
          <div className="traveldetailsseventh-content">
        ...
        <div 
          className="traveldetailsseventh-item" 
          style={{ backgroundImage: `url(http://121.4.22.55:8888/backend/images/OurHomePage/Details/TravelDetailsSeventh/3.jpg)` }}
        >
          <div className="traveldetailsseventh-content">
        ...
        <div 
          className="traveldetailsseventh-item" 
          style={{ backgroundImage: `url(http://121.4.22.55:8888/backend/images/OurHomePage/Details/TravelDetailsSeventh/4.jpg)` }}
        >
          <div className="traveldetailsseventh-content">
        ...
        <div 
          className="traveldetailsseventh-item" 
          style={{ backgroundImage: `url(http://121.4.22.55:8888/backend/images/OurHomePage/Details/TravelDetailsSeventh/5.jpg)` }}
        >
          <div className="traveldetailsseventh-content">
        ...
        <div 
          className="traveldetailsseventh-item" 
          style={{ backgroundImage: `url(http://121.4.22.55:8888/backend/images/OurHomePage/Details/TravelDetailsSeventh/6.jpg)` }}
        >
          <div className="traveldetailsseventh-content">
