...
const CarouselTypeSeventh = () => {
    ...
    const mainCarouselItems = [
        {
            title: '合川',
            subtitle: '涞滩古镇',
            src: `http://121.4.22.55:8888/backend/images/OurHomePage/CarouselTypeSeventh/1.jpg`
        },
        {
            title: '南川',
            subtitle: '山王坪',
            src: `http://121.4.22.55:8888/backend/images/OurHomePage/CarouselTypeSeventh/2.jpg`
        },
        {
            title: '恩施',
            subtitle: '双凤村',
            src: `http://121.4.22.55:8888/backend/images/OurHomePage/CarouselTypeSeventh/3.jpg`
        }
    ];
    ...
    const subCarouselItems = [
        [
            { title: '水上公路', src: `http://121.4.22.55:8888/backend/images/OurHomePage/CarouselTypeSeventh/4.jpg` },
            { title: '贡水', src: `http://121.4.22.55:8888/backend/images/OurHomePage/CarouselTypeSeventh/5.jpg` }
        ],
        [
            { title: '山王坪', src: `http://121.4.22.55:8888/backend/images/OurHomePage/CarouselTypeSeventh/6.jpg` },
            { title: '宣恩', src: `http://121.4.22.55:8888/backend/images/OurHomePage/CarouselTypeSeventh/7.jpg` }
