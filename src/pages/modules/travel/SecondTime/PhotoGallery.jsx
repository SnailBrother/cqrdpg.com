...
//http://121.4.22.55:8888/backend/images/OurHomePage/Details/PhotoGallery/5.jpg
                    ...
                    <div key={`first-${num}-${index}`} className="photogallery-card">
                        <div className="photogallery-frame">
                            <div className="photogallery-mat">
                                <img
                                    src={`http://121.4.22.55:8888/backend/images/OurHomePage/Details/PhotoGallery/${num}.jpg`}
