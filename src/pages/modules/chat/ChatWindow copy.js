...
const ChatWindow = ({ selectedFriend, username, themeSettings, userHeadImage }) => {
    ...
    const fetchUnreadCounts = async () => {
        try {
            const response = await axios.get('https://www.cqrdpg.com:5209/api/messages');
...
const formatTime = (timestamp) => {
    ...
    const fetchMessages = async (page = 1, isLoadMore = false) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.get('https://www.cqrdpg.com:5209/api/messages/chat', {
                params: {
                    senderName: username,
    ...
    const handleMarkAllAsRead = async () => {
        ...
        try {
            await axios.put('https://www.cqrdpg.com:5209/api/messages/markAllAsRead', {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            // 发送消息
            await axios.post('https://www.cqrdpg.com:5209/api/messages', {
    ...
    const handleDeleteMessages = async () => {
        ...
        try {
            await axios.delete('https://www.cqrdpg.com:5209/api/messages', {
    ...
    const markMessagesAsRead = async (messageIds) => {
        ...
        try {
            await axios.put('https://www.cqrdpg.com:5209/api/messages/read', { messageIds });
            setMessages((prevMessages) =>
                prevMessages.map((msg) =>
                    messageIds.includes(msg.message_id) ? { ...msg, is_read: 1 } : msg
                )
