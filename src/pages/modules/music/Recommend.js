...
const Recommend = () => {
    ...
    const fetchRecommendMusic = async (isFirstLoadForTab) => {
        ...
        try {
            ...
            const newMusics = response.data.data.map(song => ({
                ...
                src: song.src || `https://121.4.22.55:80/backend/musics/${song.src}`,
                coverimage: song.coverimage || 'https://121.4.22.55:80/backend/musics/default.jpg',
    ...
    const handlePlayMusic = (songToPlay) => {
        ...
        const songWithFullData = {
            ...
            src: songToPlay.src,
            coverimage: songToPlay.coverimage || 'https://121.4.22.55:80/backend/musics/default.jpg',
