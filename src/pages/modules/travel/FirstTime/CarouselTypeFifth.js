  ...
  const items = [
    {
      ...
      images: [
        { src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFifth/1.jpg`, desc: '陈宝宝下车在和妈妈打电话' },
        { src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFifth/2.jpg`, desc: '陈宝宝刚出洞口' }
      ],
      bgColor: '#4a6fa5'
    },
    {
      ...
      images: [
        { src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFifth/3.jpg`, desc: '羞涩的陈宝宝' },
        { src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFifth/4.jpg`, desc: '可爱的陈宝宝' }
      ],
      bgColor: '#c45c4a'
    },
    {
      ...
      images: [
        { src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFifth/5.jpg`, desc: '好大的瀑布' },
        { src: `https://121.4.22.55:80/backend/images/OurHomePage/CarouselTypeFifth/6.jpg`, desc: '陈宝宝被冷风吹' }
      ],
      bgColor: '#5a8f69'
    }
  ];
