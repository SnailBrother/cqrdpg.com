...
const handleSavePreviewData = (updatedData) => {
    ...
    useEffect(() => {
        ...
        const fetchAppraiserOptions = async () => {
            try {
                const response = await axios.get('https://cqrdpg.com:5202/api/getWordReportOptions');
        ...
        const fetchReportList = async () => {
            try {
                const response = await axios.get('https://cqrdpg.com:5202/api/searchWordReports');
    ...
    const reportgeneratorSearchReports = async () => {
        ...
        try {
            const response = await axios.get(
                `https://cqrdpg.com:5202/api/searchWordReports?documentNo=${reportgeneratorSearchTerm}&page=${currentPage}&pageSize=${pageSize}`
            );
    ...
    const reportgeneratorSaveReport = async (confirm) => {
        ...
        try {
            ...
            const checkResponse = await axios.get(
                `https://cqrdpg.com:5202/api/checkReportByReportID?reportID=${encodeURIComponent(reportData.reportID)}`
            );
            ...
            if (existingReport) {
                ...
                if (isConfirmed) {
                    await axios.put(
                        `https://cqrdpg.com:5202/api/updateWordReport/${existingReport.reportsID}`,
                        reportData
                    );
                ...
                // 不存在相同报告编号的报告，创建新报告
                await axios.post('https://cqrdpg.com:5202/api/createWordReport', reportData);
    ...
    const reportgeneratorDeleteReport = async (confirm) => {
        ...
        if (isConfirmed) {
            setIsLoading(true);
            try {
                await axios.delete(`https://cqrdpg.com:5202/api/deleteWordReport/${currentReportId}`);
