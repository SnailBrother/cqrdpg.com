    ...
    <>
      ...
      <div className={`${styles.player} ${className}`}>
        ...
        <div className={styles.column1}>
          <img
            src={currentSong.coverimage || 'http://121.4.22.55:8888/backend/musics/default.jpg'}
            alt={currentSong.title}
            className={styles.playerArtwork}
            onError={(e) => { e.target.onerror = null; e.target.src = 'http://121.4.22.55:8888/backend/musics/default.jpg' }}
          />
        </div>
